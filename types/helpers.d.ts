 ...
 * @return {Object}
 */
export declare const getEntity: (state: iState, key: string, id: string) => iResourceObject;
/**
 * Get an array of Entities from the state
 */
export declare const getEntities: (state: iState, key: string, ids?: string[]) => iResourceObject[];
/**
 ...
 * @return {String}
 */
export declare const getId: (obj: any) => {};
/**
 ...
 * @return {Array}
 */
export declare const getIds: (x0: {}) => {}[];
/**
